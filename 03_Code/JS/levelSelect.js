...
// important variable are explaind with JSDoc
var imgObj = null;
var imgObj2 = null;
...
$(document).ready(function() {
	...
	//
	// Saves level to submit it to next page.
	...
	//
	// This sets level = 0, and skill = '_0' to get to the tutorial level.
	...
	//
	// Shows popover (button id="confirmLevel") if there's no level selected.
	//
	...
	//
	// Closes popover by clicking anywhere.
	// Instead of using .click(function() {}); we're using .bind("click", function() {});
